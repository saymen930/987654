        ...
        if await is_maintenance() is False:
            if message.from_user.id not in SUDOERS:
                return await message.reply_text(
                    text=f"{app.mention} Baxımdadır, səbəbini öyrənmək üçün <a href={SUPPORT_GROUP}>dəstək çatına</a> daxil olun.",
                ...
                if not admins:
                    ...
                    if message.from_user.id not in admins:
                        if await is_skipmode(message.chat.id):
                            ...
                            text = f"""<b>Sizə admin hüquqlarından səs yetkisi lazımdı.</b>

Səs yetkiniz varsa /reload yazın və yenidən yoxlayın."""
        ...
        if await is_maintenance() is False:
            if CallbackQuery.from_user.id not in SUDOERS:
                return await CallbackQuery.answer(
                    f"{app.mention} Baxımdadır, səbəbini öyrənmək üçün <a href={SUPPORT_GROUP}>dəstək çatına</a> daxil olun.",
                    show_alert=True,
                )
        try:
